    ...
    def learn(self, replay_buffer, batch_size=128):
        ...
        if self.update_step % self.policy_freq == 0:
            ...
            for p_a in range(self.p_action_dim):
                ...
                q_selected = q1 if use_q1 else q2
                weighted_q = q_selected * p_action_probs[:, p_a] # discrete branch come through the expectation weighting of Q.

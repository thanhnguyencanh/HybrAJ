...
from related_works.hybrid_sac import Agent
import warnings
...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy_name", default="hybrid_sac")  # Policy name
    ...
    # Initialize policy
    policy = Agent(input_dim=state_dim, action_space=env.action_space, p_action_dim=discrete_action, alpha=0.05,
                   writer=writer, discount=args.discount, tau=args.tau, chkpt_dir=os.path.join(base, args.checkpoint))
